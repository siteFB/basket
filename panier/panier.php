...
<div class="panier content-wrapper">
    ...
    <form action="index.php?page=panier" method="post">
                    ...
                    <?php foreach ($produits as $produit) : ?>
                        <tr>
                            ...
                            <td><a href="index.php?page=produit&id=<?= $produit['id'] ?>"><?= $produit['nom'] ?></a>
                                <br>
                                <a href="index.php?page=panier&remove=<?= $produit['id'] ?>" class="remove"><i class="fas fa-trash">&nbsp;</i>Supprimer </a>
                            </td>
                            <td class="prix"> <!--&dollar; --> &#8364 <?= $produit['prix'] ?></td>
                            ...
                            <td class="prix"> <!--&dollar; --> &#8364 <?= $produit['prix'] * $produits_in_panier[$produit['id']] ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
        ...
        <div class="subtotal">
            ...
            <span class="prix"> <!--&dollar; --> &#8364 <?= $subtotal ?></span>
        </div>
        <div class="buttons">
