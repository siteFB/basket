...
/*le paramètre p peut être récupéré avec la variable $_GET['p']. En supposant que la requête est valide, le code exécutera une requête qui récupérera les produits limités de notre base de données.  */
